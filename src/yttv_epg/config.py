...
class Settings(BaseSettings):
    ...
    refresh_seconds: int = Field(default=60, validation_alias="REFRESH_SECONDS")
    full_mine_seconds: int = Field(default=300, validation_alias="FULL_MINE_SECONDS")
    ...
    mine_concurrency: int = Field(default=4, validation_alias="MINE_CONCURRENCY")
